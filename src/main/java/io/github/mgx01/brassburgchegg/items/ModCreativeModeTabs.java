...
public class ModCreativeModeTabs {
    ...
    public static final Supplier<CreativeModeTab> CHEGG = CREATIVE_MODE_TAB.register("chegg_items_tab",
            () -> CreativeModeTab.builder().icon(() -> new ItemStack(ModItems.CHEGG_DECK.get()))
                    .title(Component.translatable("creativetab.brassburgchegg.chegg_items"))
                    .displayItems((itemDisplayParameters, output) -> {
                        output.accept(ModItems.CHEGG_DECK);
                        output.accept(ModItems.CHEGG_DECK_CASE);
                        output.accept(ModBlocks.DECK_BOX);
                    }).build());
